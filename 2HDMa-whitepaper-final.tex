...
\author[38]{Giulia~Rovelli,}
\affiliation[38]{INFN Sezione di Pavia \& Dipartimento di Fisica, Università di Pavia, Pavia; Italy.}

\author[5]{Isaac~W.~Sanderson,}

\author[39,40]{Rui~Santos,}
\affiliation[39]{ISEL - Instituto Superior de Engenharia de Lisboa, \\ 
Instituto Polit\'ecnico de Lisboa, 1959-007 Lisboa, Portugal}
\affiliation[40]{Centro de F\'{\i}sica Te\'{o}rica e Computacional, Faculdade de Ci\^{e}ncias, \\ 
Universidade de Lisboa, Campo Grande, Edif\'{\i}cio C8, 1749-016 Lisboa, Portugal}

\author[41]{Stanislava~Sevova,}
\affiliation[41]{Stanford University, 450 Serra Mall, Stanford, CA 94305, USA}

\author[42]{David~Sperka,}
\affiliation[42]{Boston University, 590 Commonwealth Avenue, 02215 Boston, MA, USA}

\author[19]{Kevin~Sung,}

\author[16,*]{Tim~M.~P.~Tait,}

\author[43]{Koji Terashi,}
...
\author[44]{and~Shin-Shan~Yu}
\affiliation[44]{Department of Physics, National Central University No. 300, Zhongda Rd., \\ 
