...
%\input{texinputs/01_introduction/Introduction}
%
%\section{The model}
%\input{texinputs/02_model/Model}
%
%\section{Model parameters}
%\input{texinputs/03_theoparameters/TheoryParameters}

\input{texinputs/00_theory/theory}

\section{Model kinematics and mapping to existing models}
\input{texinputs/04_grid/ModelKinematics}
\input{texinputs/04_grid/RescalingDMHF}

\section{Parameter grid}
\label{sec:ParameterScan}
\input{texinputs/04_grid/ParameterGrid}

\section{Sensitivity studies}
\input{texinputs/04_grid/SensitivityStudies}

\section{Phenomenological studies of other signatures of \hdma}
\input{texinputs/04_grid/OtherSignatures}

\section{Connection with cosmology}
\label{sec:relic}
\input{texinputs/05_relic/RelicDensity}

%\section{Comparisons with non-collider experiments}
%\subsection{Direct detection}
%\input{texinputs/06_comparisons/DD}
%\subsection{Indirect detection}
%\input{texinputs/06_comparisons/ID}
%
%%%%%%%%%%%%%%%%
