...
\input{texinputs/04_grid/ModelKinematics.tex}
\input{texinputs/04_grid/RescalingDMHF.tex}

\section{Parameter grid}
\input{texinputs/04_grid/ParameterGrid.tex}

\section{Sensitivity studies}
\input{texinputs/04_grid/SensitivityStudies.tex}
...
\input{texinputs/06_comparisons/DD.tex}
\subsection{Indirect detection}
\input{texinputs/06_comparisons/ID.tex}
