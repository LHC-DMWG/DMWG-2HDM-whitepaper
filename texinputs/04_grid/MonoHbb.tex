...
%\begin{figure}[tbp]
%\centering
%\includegraphics[width=\textwidth]{texinputs/04_grid/figures/monoHbb_sinp_scan_MA1000_Ma350_MET_liny_norm2one.pdf}
%\caption[$\MET$ distribution in $h\rightarrow bb + \MET$ events for different 
%$\sinp$ for $\mA = \mH = \mHc = 1000 $ GeV and $\ma = 350$ GeV]
%{
%Missing transverse momentum distribution of $h\rightarrow bb + \MET$ signal 
%events at parton level for five representative models with different $\sinp$ and
% fixed $\mA = \mH = \mHc = 1000 $~GeV, $\ma = 350$~GeV, $ \mDM = 10$~GeV, $\tanb = 1$, 
%and $ \lap1 = \lap2 = \lam3 = 3 $. %
%}
%\label{fig:monoHbb_sinp_scan_mA1000_ma350_met}
%\end{figure}
