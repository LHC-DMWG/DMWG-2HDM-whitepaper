...
%may want to drop the paragraphs here, if no monohyy input forthcoming...
 
\paragraph{\monohbb signature} For the case where the Higgs bososn decays into two $b$-quarks, such as studied in \cite{Aaboud:2017yqz}, the signal kinematics are studied at parton level. 
