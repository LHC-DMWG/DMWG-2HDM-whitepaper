...
The \textbf{masses $\boldsymbol{\mA,\,\mH}$, and $\boldsymbol{\ma}$ of the pseudoscalars $\boldsymbol{A}$ and $\boldsymbol{a}$ and the scalar $\boldsymbol{H}}, which are the mediators of the resonant mono-$h$ and mono-$Z$ processes, affect the shape of the $\MET$ distribution of these processes. 
