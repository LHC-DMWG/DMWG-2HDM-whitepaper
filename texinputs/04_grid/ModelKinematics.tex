...
In the region of inverted mass hierarchy $\mH < \ma$, the \MET spectrum is less structured and does not fall off as steeply towards higher values. For a small mass splitting of $\ma-\mH\approx M_{Z}$, the spectrum is shifted to much lower values of \MET.
