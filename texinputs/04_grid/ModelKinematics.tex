...
For this reason, and since the production cross section times branching ratio for the $b\bar{b}$ + \MET signature is enhanced at high values of $\tan\beta$ (see Eq. 3.2 and 3.3 in Ref.~\cite{Bauer:2017ota}) \emph{it is desirable to perform a coarse scan in $\tan\beta$ as well}. 
