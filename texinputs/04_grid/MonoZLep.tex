...
\caption{Performing one dimensional scans of $\tan{\beta}$ for fixed \mA =600 \GeV and \ma = 150 \GeV (left) and $\sin{\theta}$ for fixed \mA = 600 \GeV and \ma = 250 \GeV (right) shows these parameter have little impact on the event's kinematic distributions.  For small values of \tanb, there is a slight softening and broadening of the \MET distribution due to the increased contribution from the top box feynman diagram.}
