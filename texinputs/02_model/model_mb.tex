...
%
%Simplified models have become an essential tool for Dark Matter searches at the LHC. They allow to constrain a large number of possible extensions of the Standard Model (SM) by only including the degrees of freedom relevant to the dark sector and its connection to SM particles. The embedding of pseudoscalar mediators into two Higgs doublet models (2HDMs) cure the theoretical inconsistencies of simplified models with a pseudoscalar singlet and -as a consequence- extends the spectrum and of possible signatures significantly. Another motivation is derived from the fact that supersymmetric extensions of the SM require additional Higgs doublets (MSSM), and additional pseudoscalars (NMSSM)  
