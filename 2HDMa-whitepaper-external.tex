...
%%%% BEGIN CLEAN-UP OF AUTHORLIST

%%%%%%%%
%%Those who replied to my email in July
%%%%%%%%

%-name: Stanislava Sevova
%-affiliation: Stanford University (though I was Northwestern University while the work was being done)
%-address: 450 Serra Mall, Stanford, CA 94305, USA (or for NU: 633 Clark St, Evanston, IL 60208, USA)
%-contribution: ttbar + MET cross-checks and plots
...
%contribution: Nicole Bell: direct detection constraints, relic density, 2HDM+scalar model.
%...and similarly for Isaac and Giorgio (unless Giorgio prefers some alternative wording).

%- name: Tania Robens
%- affiliation: MTA-DE Particle Physics Research Group, University of Debrecen
%- address of affiliation: 4010 Debrecen, Hungary
%- extra acknowledgment lines you would like to add (e.g. if your funding agency / grant number needs to be acknowledged)?
%This material is based in part upon work supported by part by the National Science Centre, Poland, the HARMONIA project under contract UMO-2015/18/M/ST2/00518 (2016-2019), and by grant K 125105 of the National Research, Development and Innovation Fund in Hungary.
%contribution: Inert Doublet Model material and appendix

%-Name: Jose Miguel No
%-Affiliation: 1) Departamento de Fisica Teorica and Instituto de Fisica Teorica, IFT-UAM/CSIC
%                    2) Department of Physics, King?s College London 
%-Address of affiliation: 1) Universidad Autonoma de Madrid, Cantoblanco, 28049, Madrid, Spain 
%                                       2) Strand, WC2R 2LS London, UK
%-Acknowledgements: The work of J. M. No was partially supported by the European Research Council under the European Unions Horizon 2020 program (ERC Grant Agreement no.648680 DARKHORIZONS), and by the Programa Atraccion de Talento de la Comunidad de Madrid under grant n. 2017-T1/TIC-5202.
%contribution: "Stability study of the 2HDM+a, towards definition of benchmarks for mono-h and mono-Z analyses".

%Name: Tim M.P. Tait
%Affiliation: University of California, Irvine
%Address: Department of Physics and Astronomy, University of California, Irvine 92697, USA
%Acknowledgement: The work of TMPT is supported in part by NSF grant PHY-1316792.
%contribution: DMWG organizer

%Shin-Shan Yu
% Department of Physics, National Central University
% No. 300, Zhongda Rd., Zhongli District, Taoyuan City 32001, Taiwan
%Contribution: supervision of mono-Higgs studies

%Janna Katharina Behr: help with coordination of ATLAS studies; re-interpretation of A/H-->ttbar search
%Yu-Heng Chen: re-interpretation of A/H-->ttbar search; modification of UFO to include signal-background interference
% We are both affiliated with DESY (Notkestr. 85, 22609 Hamburg, Germany). Acknowledgements for us should include the Helmholtz Foundation.

%\author[1,]{Andreas~Albert,}
%\affiliation[1]{III. Physikalisches Institut A, RWTH Aachen University, Aachen, Germany}
%Name:                Andreas Albert
%Affiliation:         III. Physikalisches Institut A, RWTH Aachen University
%Address:             Physikzentrum, Otto-Blumenthal-Straße, Aachen
%Acknowledgement:     Andreas Albert receives support from the German Federal Ministry of Education and Research under grant agreement 05H15PACC1.
%Contribution: Cross-sections, acceptances and kinematic distributions for the 2HDM mono-Z analysis, and relic density results.


%Linda M Carpenter
%Ohio State University
%US department of Energy  grant DE- SC0011726
%"Linda Carpenter: Indirect Detection annihilation signatures of 2HDM"


%- name: Lars Henkelmann
%- affiliation: Kirchhoff-Institut für Physik, Ruprecht-Karls-Universität Heidelberg
%- address of affiliation: Im Neuenheimer Feld 227, 69120 Heidelberg, Germany
%- contributions: design of 2HDM+a parameter scans,  2HDM+a kinematic distributions for mono-h (ma,mA,mH, mDM variations), 2HDM+a  cross-sections and sensitivity estimates for mono-h

%%%%%%%%
%%%%Those I know did something
%%%%%%%%

%Chris Anelli
%Priscilla Pani
%Shin-shan's postdoc - Benedikt Maier? 
%Kevin Sung

%contacted, deadline by Tuesday:

%Kevin Kai Hong Sung <kevin.kai.hong.sung@cern.ch>, Priscilla Pani <Priscilla.Pani@cern.ch>, Giacomo Polesello <Giacomo.Polesello@cern.ch>, Francesca Ungaro <Francesca.Ungaro@cern.ch>, Johanna Gramling <jgramlin@cern.ch>, Oleg Brandt <oleg.brandt@cern.ch>, Martin Bauer <counterterm@gmail.com>, Koji Terashi <koji.terashi@cern.ch>

%Priscilla Pani
%Deutsches Elektronen-Synchrotron DESY, Hamburg and Zeuthen.
%Notkestraße 85 22607 Hamburg and Platanenallee 6, 15738 Zeuthen, Germany 
%contribution: 4-top studies (cross-section, model implementation, interference with SM checks). Wt+MEt signature studies. 
...
%all contacted, deadline by Tuesday
...
%- name.      Margarete Muhlleitner (no 'ü', no 'ue' in the name)
%- affiliation. Institute for Theoretical Physics, Karlsruhe Institute of Technology
%- address of affiliation. Wolfgang-Gaede-Str. 1, 76131 Karlsruhe, Germany
%- extra acknowledgment lines you would like to add (e.g. if your funding agency / grant number needs to be acknowledged)?  None to be added

%Marie-Hélène Genest
%Univ. Grenoble Alpes, CNRS, Grenoble INP*, LPSC-IN2P3, 38000 Grenoble, France

%Raffaele Gerosa
%a) Nome: Raffaele Gerosa
%b) Institute: University California San Diego (UCSD)
%c) Indirizzo: Department of Physics, 9500 Gilman Drive, La Jolla, CA 92093-0319
%d) Non ho un grant mio però il mio advisor è finanziato dal DOE. Quindi suggerirei di aggiungere, se fosse possibile, una frase del tipo: "We gratefully acknowledge the support by the U.S. Department of Energy (DOE)".

%- name: Rui Santos
%- affiliation1: ISEL - Instituto Superior de Engenharia de Lisboa
%- address of affiliation1:  Instituto Polit\'ecnico de Lisboa, 1959-007 Lisboa, Portugal
%- affiliation2: Centro de F\'{\i}sica Te\'{o}rica e Computacional, Faculdade de Ci\^{e}ncias, Universidade de Lisboa
%- address of affiliation2: Campo Grande, Edif\'{\i}cio C8, 1749-016 Lisboa, Portugal
...
\subsubsection{Variation of $\bm{\tan \beta}$}
...
The modifications of the $\MET$~($p_{T,Z}$) spectrum in $h+\MET$~($Z+\MET$) production under a variation of the DM mass $m_\chi$ are illustrated in the two panels of Figure~\ref{fig:mdmvar}. The given predictions correspond to $pp$ collision at $13 \, {\rm TeV}$ and employ the benchmark parameters~\eqref{eq:benchmark} with $\mH = \mA = \mHc = 700 \, {\rm GeV}$ and $\ma = 300 \, {\rm GeV}$. The depicted scenarios with $\ma  > 2 m_\chi$ (green and orange histograms) lead to almost identical rates, $\MET$ and $p_{T,Z}$ spectra, while the choice $\ma  < 2 m_\chi$ (blue histograms) 
