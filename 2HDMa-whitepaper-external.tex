...
\affiliation[14]{Laboratoire de Physique Subatomique et de Cosmologie, Universite Grenoble-Alpes, \\ 
CNRS/IN2P3, 53 rue des Martyrs, 38026 Grenoble Cedex, France}
...
\author[29]{Kentarou~Mawatari,}
\affiliation[29]{Department of Physics, Osaka University, Toyonaka, Osaka 560-0043, Japan}

\author[30]{Margarete~Muehlleitner,}
\affiliation[30]{Institute for Theoretical Physics, Karlsruhe Institute of Technology, \\ Wolfgang-Gaede-Str. 1, 76131 Karlsruhe, Germany}
...
\author[37,38]{Rui~Santos,}
\affiliation[37]{ISEL - Instituto Superior de Engenharia de Lisboa, \\ 
Instituto Polit\'ecnico de Lisboa, 1959-007 Lisboa, Portugal}
\affiliation[38]{Centro de F\'{\i}sica Te\'{o}rica e Computacional, Faculdade de Ci\^{e}ncias, \\ 
Universidade de Lisboa, Campo Grande, Edif\'{\i}cio C8, 1749-016 Lisboa, Portugal}

\author[39]{Stanislava~Sevova,}
\affiliation[39]{Stanford University, 450 Serra Mall, Stanford, CA 94305, USA}

\author[40]{David~Sperka,}
\affiliation[40]{Boston University, 590 Commonwealth Avenue, 02215 Boston, MA, USA}
...
\author[41]{and Shin-Shan~Yu}
\affiliation[41]{Department of Physics, National Central University No. 300, Zhongda Rd., \\ 
...
G.~Busoni et~al., {\it {Recommendations on presenting LHC searches for missing
...
{\bf ATLAS} and {\bf CMS} Collaborations, G.~Aad et~al., {\it {Measurements of the Higgs
...
{\bf CMS} Collaboration, {\it {Combined measurements of the Higgs boson's
  couplings at $\sqrt{s}$~=~13~TeV}},  CMS-PAS-HIG-17-031, CERN,
  Geneva, 2018.

\bibitem{Aaboud:2017cxo}
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for heavy resonances
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for additional heavy
...
{\bf CMS} Collaboration, A.~M. Sirunyan et~al., {\it {Search for additional
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for Heavy Higgs
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for pair production
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for heavy ZZ
...
{\bf CMS} Collaboration, A.~M. Sirunyan et~al., {\it {Search for beyond the
...
\bibitem{Aad:2015pla}
{\bf ATLAS} Collaboration, G.~Aad et~al., {\it {Constraints on new phenomena
...
{\bf CMS} Collaboration, V.~Khachatryan et~al., {\it {Searches for invisible
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for dark matter in
...
{\bf CMS} Collaboration, {\it {Search for dark matter produced in association
  with a Higgs boson decaying to $\gamma\gamma$ or $\tau^+\tau^-$ at
  $\sqrt{s}$~=~13~TeV with the CMS detector}},  
  CMS-PAS-EXO-16-055, CERN, Geneva, 2018.
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for an invisibly
...
{\bf CMS} Collaboration, A.~M. Sirunyan et~al., {\it {Search for new physics in
...
\bibitem{Aad:2013oja}
{\bf ATLAS} Collaboration, G.~Aad et~al., {\it {Search for dark matter in
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for dark matter
...
{\bf CMS} Collaboration, A.~M. Sirunyan et~al., {\it {Search for dark matter
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for dark matter and
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for charged Higgs
...
\bibitem{Aad:2015typ}
{\bf ATLAS} Collaboration, G.~Aad et~al., {\it {Search for charged Higgs bosons
...
{\bf CMS} Collaboration, V.~Khachatryan et~al., {\it {Search for a charged
...
{\bf XENON} Collaboration, E.~Aprile et~al., {\it {Dark Matter Search Results
  from a One Tonne$\times$Year Exposure of XENON1T}},
  \href{http://arxiv.org/abs/1805.12562}{{\tt arXiv:1805.12562}}.
...
{\bf DES, Fermi-LAT} Collaboration, A.~Albert et~al., {\it {Searching for Dark
...
{\bf ATLAS} Collaboration, M.~Aaboud et~al., {\it {Search for top-squark pair
